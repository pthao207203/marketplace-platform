...
export const ENV = {
  ...
  MONGO_URI: parseInt(process.env.MONGO_URI || 'MONGO_URI=mongodb+srv://NT118:Abc%40123@cluster0.xugiqbr.mongodb.net/NT118?retryWrites=true&w=majority&appName=Cluster0', 10),
