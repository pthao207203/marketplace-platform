// 1. SỬA: Thêm 'Document' vào dòng import này
...
// Interface này cần kế thừa Document để có các thuộc tính như _id, save(), ...
...
const OrderSchema = new Schema<IOrder>(
  {
    orderBuyerId: { type: Schema.Types.ObjectId, ref: 'User', required: true, index: true },
