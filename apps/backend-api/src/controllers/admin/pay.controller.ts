...
import { PAYMENT_METHOD, PAYMENT_STATUS } from "../../constants/order.constants";
...
export const index = async (req: Request, res: Response) => {
  try {
    ...
    .select("appTransId orderTotalAmount orderStatus orderPaymentStatus orderPaymentMethod createdAt orderBuyerId")
