...
export const USER_STATUS_LABEL: Record<UserStatusCode, 'active' | 'inactive' | 'banned'> = {
  [USER_STATUS.ACTIVE]: 'active',
  [USER_STATUS.INACTIVE]: 'inactive',
  [USER_STATUS.BANNED]: 'banned',
};

export const USER_ROLE_LABEL: Record<UserRoleCode, 'guest' | 'customer' | 'shop' | 'admin'> = {
...
export const USER_STATUS_CODE: Record<'active' | 'inactive' | 'banned', UserStatusCode> = {
  active: USER_STATUS.ACTIVE,
  inactive: USER_STATUS.INACTIVE,
  banned: USER_STATUS.BANNED,
};

export const USER_ROLE_CODE: Record<'guest' | 'customer' | 'shop' | 'admin', UserRoleCode> = {
