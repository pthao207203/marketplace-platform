...
export type ProductDeletedCode =
  (typeof PRODUCT_DELETED)[keyof typeof PRODUCT_DELETED];
...
export const PRODUCT_STATUS_CODE: Record<
  "active" | "inactive" | "draft" | "archived",
  ProductStatusCode
> = {
...
export type ProductPriceType =
  (typeof PRODUCT_PRICE_TYPE)[keyof typeof PRODUCT_PRICE_TYPE];

export const PRODUCT_PRICE_TYPE_VALUES = [
  PRODUCT_PRICE_TYPE.FIXED,
  PRODUCT_PRICE_TYPE.NEGOTIABLE,
  PRODUCT_PRICE_TYPE.AUCTION,
] as const;
...
export const NEGOTIATION_STATUS_VALUES = [
  NEGOTIATION_STATUS.PENDING,
  NEGOTIATION_STATUS.ACCEPTED,
  NEGOTIATION_STATUS.REJECTED,
  NEGOTIATION_STATUS.CANCELLED,
  NEGOTIATION_STATUS.PURCHASED,
] as const;
