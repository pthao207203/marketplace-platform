              ...
              {loading ? (
                ...
                customers.map((c) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-6 text-center">
                      {c.status === "active" ? (
                        <span className="px-3 py-1 rounded-full border border-green-200 bg-green-50 text-green-700 text-xs font-semibold">
                          Hoạt động
                        </span>
                      ) : (
                        <span className="px-3 py-1 rounded-full border border-red-200 bg-red-50 text-red-700 text-xs font-semibold">
                          {c.status === "deleted" ? "Đã xóa" : "Đã khóa"}
                        </span>
                      )}
                    </td>
                  </tr>
