...
const dummyNegotiationData: ProductNegotiation[] = [
    {
        id: 1,
...
export default function DetailNegotiation() {
    const { id } = useParams();

    const data = useMemo(() => {
        return dummyNegotiationData.find((p) => p.id === Number(id));
    }, [id]);
        ...
        <div className="w-full h-full py-[20px] px-[30px] bg-white/60">
            ...
            <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex gap-[10px]">
                    <Link
                        to={`/product/negotiation/${id}/history`}
