...
const othersItems: NavItem[] = [
  {
    icon: <img src={SettingIcon} alt="Settings" className="w-6 h-6" />,
    name: "Setting",
    subItems: [
  ...
  {
    icon: <img src={PolicyIcon} alt="Policy" className="w-6 h-6" />,
    name: "Policy",
    subItems: [
  ...
  {
    icon: <img src={AuthenticationIcon} alt="Authentication" className="w-6 h-6" />,
    name: "Authentication",
    subItems: [
